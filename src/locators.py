...
text_fillings = By.XPATH, '//p[text()="Мясо бессмертных моллюсков Protostomia"]'
text_sause = By.XPATH, '//p[text()="Соус Spicy-X"]'
text_bread = By.XPATH, '//p[text()="Флюоресцентная булка R2-D3"]'
